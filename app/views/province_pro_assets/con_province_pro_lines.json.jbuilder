...
if (session[:start_date].present? and session[:end_date].present?)
	json.one_line ProvinceProAsset.joins(pro_concretes: :pro_concrete_subs).where('pro_concretes.day': (start_date)..(end_date)).where('province_pro_assets.id': params[:province_id]).select("pro_concretes.day, sum(pro_concrete_subs.pro_concrete_amount) as amount").group("pro_concretes.day").order("pro_concretes.day")
	...
	json.one_line ProvinceProAsset.joins(pro_concretes: :pro_concrete_subs).where('pro_concretes.day': (start_date)..(last_date)).where('province_pro_assets.id': params[:province_id]).select("pro_concretes.day, sum(pro_concrete_subs.pro_concrete_amount) as amount").group("pro_concretes.day").order("pro_concretes.day")
	...
	json.one_line ProvinceProAsset.joins(pro_concretes: :pro_concrete_subs).where('pro_concretes.day': (first_date)..(end_date)).where('province_pro_assets.id': params[:province_id]).select("pro_concretes.day, sum(pro_concrete_subs.pro_concrete_amount) as amount").group("pro_concretes.day").order("pro_concretes.day")
	...
	json.one_line ProvinceProAsset.joins(pro_concretes: :pro_concrete_subs).where('pro_concretes.day': (first_date)..(last_date)).where('province_pro_assets.id': params[:province_id]).select("pro_concretes.day, sum(pro_concrete_subs.pro_concrete_amount) as amount").group("pro_concretes.day").order("pro_concretes.day")
