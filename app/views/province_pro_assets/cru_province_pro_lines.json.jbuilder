...
if (session[:start_date].present? and session[:end_date].present?)
	json.one_line ProvinceProAsset.joins(pro_crushers: :pro_crusher_subs).where('pro_crushers.day': (start_date)..(end_date)).where('province_pro_assets.id': params[:province_id]).select("pro_crushers.day, sum(pro_crusher_subs.pro_crusher_amount_meters) as amount").group("pro_crushers.day").order("pro_crushers.day")
	...
	json.one_line ProvinceProAsset.joins(pro_crushers: :pro_crusher_subs).where('pro_crushers.day': (start_date)..(last_date)).where('province_pro_assets.id': params[:province_id]).select("pro_crushers.day, sum(pro_crusher_subs.pro_crusher_amount_meters) as amount").group("pro_crushers.day").order("pro_crushers.day")
	...
	json.one_line ProvinceProAsset.joins(pro_crushers: :pro_crusher_subs).where('pro_crushers.day': (first_date)..(end_date)).where('province_pro_assets.id': params[:province_id]).select("pro_crushers.day, sum(pro_crusher_subs.pro_crusher_amount_meters) as amount").group("pro_crushers.day").order("pro_crushers.day")
	...
	json.one_line ProvinceProAsset.joins(pro_crushers: :pro_crusher_subs).where('pro_crushers.day': (first_date)..(last_date)).where('province_pro_assets.id': params[:province_id]).select("pro_crushers.day, sum(pro_crusher_subs.pro_crusher_amount_meters) as amount").group("pro_crushers.day").order("pro_crushers.day")
