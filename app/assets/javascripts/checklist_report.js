function checklist_report(data_url) {
    ...
    $.ajax({
      ...
      success: function(result){
        ...
        $('#checklists_meters_different_id').html(result.checklists_meters_end_date - result.checklists_meters_start_date);
        $('#checklists_meters_average_id').html(parseFloat((result.checklists_meters_end_date - result.checklists_meters_start_date) / result.checklists_meters_count).toFixed(2));
